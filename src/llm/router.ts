...
export type ModelClass = "reasoning" | "fast" | "economy" | "cheap" | "coding";
...
const MODELS: Record<ModelClass, ModelEntry[]> = {
	...
	economy: [
		{ id: "deepseek/deepseek-v4-flash", contextWindow: 1_000_000, maxTokens: 8192, cost: { input: 0.1, output: 0.2 } },
